...
def make_hartmann_case(
    ...
    return CaseSpec(
        ...
        time_stepper=TimeStepperConfig(dt=0.01, t_final=1.0, max_steps=100, potential_iterations=200),
...
def make_shercliff_case(
    ...
    return CaseSpec(
        ...
        time_stepper=TimeStepperConfig(dt=0.01, t_final=1.5, max_steps=150, potential_iterations=225),
        output=OutputSpec(directory=output_dir),
        forcing=1.0,
        reference_pressure_gradient=-1.0,
        reference_phi_cell=anchor,
