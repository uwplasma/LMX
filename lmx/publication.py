...
PUBLICATION_FIGURE_SPECS: tuple[PublicationFigureSpec, ...] = (
    PublicationFigureSpec(
        ...
        generator="campaigns/ducts/straight_duct_profile_comparison.py",
    ...
    PublicationFigureSpec(
        ...
        generator="campaigns/ducts/straight_duct_validation_ladder.py",
    ...
    PublicationFigureSpec(
        ...
        generator="campaigns/blanket/wham_blanket_flow_demo.py",
    ...
    PublicationFigureSpec(
        ...
        generator="campaigns/blanket/wham_blanket_autodiff_research_demo.py",
    ...
    PublicationFigureSpec(
        ...
        generator="campaigns/walls/li_aln_wall_stack_phase0_2.py",
    ...
    PublicationFigureSpec(
        ...
        generator="campaigns/walls/li_aln_wall_stack_phase3_6.py",
        reference="Thin-wall conductance, coated-wall leakage, and Li/AlN wall-stack study plan",
    ...
    PublicationFigureSpec(
        ...
        generator="campaigns/walls/li_aln_multilayer_mesh_qa.py",
    ...
    PublicationFigureSpec(
        ...
        generator="campaigns/walls/li_aln_multilayer_solve.py",
        reference="Coated-wall MHD conductance models and conservative interface-current diagnostics",
    ...
    PublicationFigureSpec(
        ...
        generator="campaigns/walls/li_aln_multilayer_convergence.py",
        reference="Coated-wall MHD conductance models and conservative interface-current diagnostics",
    ...
    PublicationFigureSpec(
        ...
        generator="campaigns/magnetic_obstacle/magnetic_obstacle_benchmark.py",
    ...
    PublicationFigureSpec(
        ...
        generator="campaigns/q2d/q2d_wall_bounded_validation.py",
    ...
    PublicationFigureSpec(
        ...
        generator="campaigns/fringing/bent_pipe_inductionless_demo.py",
    ...
    PublicationFigureSpec(
        ...
        generator="campaigns/fields/variable_field_tabulated_demo.py",
    ...
    PublicationFigureSpec(
        ...
        generator="campaigns/status/research_grade_closure_dashboard.py",
