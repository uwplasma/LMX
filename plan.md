...
13. **Active — optimize and scale accepted paths.** Establish reproducible single-CPU and
   ...
   GPU graph. The exact-commit A4000 ladder has restart times `6.28`, `13.28`,
   and `24.69 s`; the `11 x 17 x 32` row has mean flow `0.99999999970`, charge
   residual `2.05e-9`, and divergence `7.48e-6`. The rejected point-diagonal
