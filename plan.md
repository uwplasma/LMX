...
- Portable gate: 768 passed, 8 expected external-data skips, 95.28% branch
  coverage, 170.9 seconds on the reference Mac.
...
- Repository consolidation: the root provenance tree and historical campaign,
  ...
  The maintained checkout has 41 test files, 23 maintenance scripts, 13 compact
