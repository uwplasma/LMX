...
addition may use one module and at most 300 net package lines, setting a narrow
capability-adjusted ceiling of 15,300 lines across 16 modules.

The tranche has five coupled outcomes:
...
| package source | 30,852 lines / 32 modules | **<= 15,300 lines / <= 16 implementation modules** |
...
| Q2D flow | keep one compact physical path | LMX owns the SM82 vorticity model and diagnostics; released SOLVAX owns periodic Poisson inversion |
