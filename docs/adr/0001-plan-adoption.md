...
Change the plan only at phase boundaries or when a new ADR changes a decision.
Consequence: implementation alone does not establish validation or close a gate.
