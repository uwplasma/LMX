...
|---|---|---|---|
| portable test gate | Apple M4, six workers | 837 pass, 8 skip, 95.58% combined line/branch coverage, 159.4 s | 6.0% faster than the prior shared-host record; below five-minute target |
