...
![Current B2 two-update CPU and GPU scaling calibration](_static/strong_scaling.webp)

## Current evidence

| Path | Hardware and grid | Result | Interpretation |
|---|---|---|---|
| portable test gate | Apple M4, six workers | 823 pass, 8 skip, 95.00% combined line/branch coverage, 152.1 s | below the five-minute target |
