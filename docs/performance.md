...
|---|---|---|---|
| portable test gate | Apple M4, six workers | 859 pass, 8 skip, 95.32% combined line/branch coverage, 143.5 s | below half of the five-minute target and 25% of the ten-minute budget |
