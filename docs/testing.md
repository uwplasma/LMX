...
and a hard ten-minute timeout. The current Apple M4 result is 782 passed, 8
expected external-data skips, 95.30% branch coverage, and 162.8 seconds with six
