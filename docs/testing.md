...
and a hard ten-minute timeout. The current Apple M4 result is 787 passed, 8
expected external-data skips, 95.29% branch coverage, and 189.8 seconds with six
workers.
