...
and a hard ten-minute timeout. The current Apple M4 record is 867 passed,
8 expected external-data skips, 95.41% combined line/branch coverage, and 121.5
...
| Sharding and scaling | scaling and placement tests | exact topology plus monitored multi-minute records | Docker CPU-allocation accepted; physical-core and authoritative GPU scaling open |
