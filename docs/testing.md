...
and a hard ten-minute timeout. The current Apple M4 result is 770 passed, 8
expected external-data skips, 95.35% branch coverage, and 171.1 seconds with six
