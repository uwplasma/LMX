...
and a hard ten-minute timeout. The current Apple M4 result is 796 passed, 8
expected external-data skips, 95.33% branch coverage, and 200.3 seconds with six
workers.
