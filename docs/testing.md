...
and a hard ten-minute timeout. The current Apple M4 result is 788 passed, 8
expected external-data skips, 95.34% branch coverage, and 210.5 seconds with six
workers.
