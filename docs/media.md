...
| B2 schema-6 CPU evidence | 49,758 | 1,400 × 1,329 WebP | forced-device calibration plus affinity-controlled 2/4/8-CPU repeated confirmation from `b2-schema6-cpu-scaling-20260716.json`; neither is sustained or steady-production scaling |
