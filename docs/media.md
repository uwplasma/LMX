...
| B2 schema-6 scaling evidence | 90,908 | 1,760 × 1,616 WebP | current-source large-work CPU scaling plus multi-minute shared-host GPU calibration; exact host-core and GPU idle-host claims remain open |
