...
| CPU/GPU parallelism | forced-device calibration plus sustained CPU/GPU timing | CPU allocation scaling accepted; exact host-core and idle-host GPU claims open |
...
Twenty files in `docs/_static/` total 1,246,402 bytes. The `showcase` section of
...
| B2 field, pressure, and acceleration | 46,284 | 1,000 × 895 WebP | released field/pressure source plus current cold gate; Anderson rejected before step 29 |
...
| `readme-alex-b2-field-pressure.webp` | `4488a4734af0577d6a77d26357258d551b4b75f7b0a2c35667ffddc0687a7e2d` |
