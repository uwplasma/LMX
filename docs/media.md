...
Twenty files in `docs/_static/` total 1,253,324 bytes. The `showcase` section of
...
| B2 schema-6 scaling evidence | 61,268 | 1,400 × 1,285 WebP | promoted callback-free multi-minute CPU scaling plus calibration-only multi-minute shared-host GPU scaling; authoritative GPU idle-host claim remains open |
