...
history first satisfies `max(relative update) <= 2e-3` at step 57 (2.85 s),
with a window maximum of `1.860420834008e-3`. Source frame 21 is step 58
(2.90 s), where the visible terminal 18-update metric is
