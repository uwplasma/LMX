...
| B2 schema-6 scaling evidence | 80,362 | 1,400 × 1,860 WebP | forced-device CPU calibration, accepted sustained physical-CPU scaling, and sustained shared-host GPU calibration; GPU idle-host claim remains open |
