...
The current checkpoint records 35 package modules and 35,022 total
...
The current tracked checkout is 3,565,237 bytes, below its 4 MiB hard cap.
...
- Reference coverage lane: 818 tests pass with 95.01% combined line/branch
