...
The current checkpoint records 35 package modules and 34,943 total
package lines. The maintained stable core is 7,927 lines;
...
The current tracked checkout is 3,329,894 bytes, below its 4 MiB hard cap.
...
- Reference coverage lane: 815 tests pass with 95.11% combined line/branch
