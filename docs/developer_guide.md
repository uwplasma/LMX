...
The current tracked checkout is 3,476,260 bytes, below its 4 MiB hard cap. Sixty-five
...
8,100 maintained-core lines, 31 test files, 21,100 test lines, 16 maintenance
