...
The current checkpoint records 35 package modules and 34,968 total
package lines. The maintained stable core is 7,931 lines;
...
The current tracked checkout is 3,341,224 bytes, below its 4 MiB hard cap.
...
- Reference coverage lane: 818 tests pass with 95.03% combined line/branch
