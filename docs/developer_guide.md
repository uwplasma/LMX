...
The current tracked checkout is 4,579,089 bytes, below its 4.5 MiB hard cap.
...
SHA-256 verification. Twenty compressed web derivatives (1,253,324 bytes total)
