...
The current checkpoint records 35 package modules and 34,874 total
...
The current tracked checkout is 3,489,557 bytes, below its 4 MiB hard cap. Sixty-five
...
SHA-256 verification. Six compressed web derivatives (389,303 bytes total) remain in
...
- Reference coverage lane: 823 tests pass with 95.00% combined line/branch
