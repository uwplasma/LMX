...
The current checkpoint records 35 package modules and 34,809 total
package lines. The maintained stable core is 7,896 lines;
...
The current tracked checkout is 3,323,316 bytes, below its 4 MiB hard cap.
...
- Reference coverage lane: 816 tests pass with 95.06% combined line/branch
