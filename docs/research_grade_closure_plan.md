...
`examples/research_grade_closure_dashboard.py`. It combines the closed
...
![Strict research-grade validation closure dashboard](_static/generated/research_grade_closure_dashboard.png)

The final strict-lane disposition is generated by
`examples/research_grade_final_lane_disposition.py`. It is the last-push audit
...
![Final strict research-lane disposition](_static/generated/research_grade_final_disposition.png)
