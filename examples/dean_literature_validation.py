...
def run_dean_literature_validation(
    *,
    ...
    table_path = _write_dean_reference_table(reference_rows, out_dir / "dean_literature_reference_observables.csv")
    plots = write_dean_literature_validation_plots(comparison, out_dir, output_stem=OUTPUT_STEM)
    summary = {
        **comparison,
        "case": OUTPUT_STEM,
