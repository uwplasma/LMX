...
def run_research_grade_external_data_audit(
    *,
    ...
    audit_path = write_research_grade_external_data_audit(out_dir, static_dir=docs_output_dir)
    ...
    print(f"available_sources = {summary['available_source_count']}/{summary['source_count']}")
