...
from lmx import generate_bent_pipe_mesh, write_geometry_preview_plots
...
def run_bent_pipe_preview() -> dict[str, object]:
    ...
    plots = write_geometry_preview_plots(mesh, OUTPUT_DIR, case_title="Bent pipe geometry")
    summary = {
    ...
    (OUTPUT_DIR / "bent_pipe_preview_summary.json").write_text(json.dumps(summary, indent=2) + "\n")
    return summary
