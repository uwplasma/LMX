...
from lmx import build_magnetic_obstacle_rect_extruded_problem, solve_extruded_inductionless, validate_magnetic_obstacle_baseline, write_extruded_overview_plots
...
def run_magnetic_obstacle_baseline() -> dict[str, object]:
    ...
    plots = write_extruded_overview_plots(solution, OUTPUT_DIR, case_title="Magnetic-obstacle baseline")
    ...
    (OUTPUT_DIR / "magnetic_obstacle_baseline_summary.json").write_text(json.dumps(summary, indent=2) + "\n")
    return summary
