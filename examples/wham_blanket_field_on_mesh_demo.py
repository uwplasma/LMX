...
def run_wham_blanket_field_on_mesh_demo() -> dict[str, object]:
    ...
    centerline = build_wham_blanket_centerline(geometry, straight_points=96, bend_points=192)
    ...
    print(f"max_cross_section_relative_B_span = {metrics['max_cross_section_relative_b_span']:.3e}")
