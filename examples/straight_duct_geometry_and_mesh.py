...
from lmx import write_lm_duct_geometry_setup_figure, write_structured_mesh_figure
...
def run_straight_duct_geometry_and_mesh_demo(
    *,
    ...
    (out_dir / "straight_duct_geometry_and_mesh_summary.json").write_text(json.dumps(summary, indent=2) + "\n")
    return summary
