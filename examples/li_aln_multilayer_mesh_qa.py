...
from lmx import LithiumMaterial, WallStackStudyCase, write_li_aln_multilayer_mesh_artifacts
...
def run_li_aln_multilayer_mesh_qa(
    *,
    ...
    print(f"ready for current diagnostics = {summary['qa']['ready_for_conservative_current_diagnostics']}")
    return summary
