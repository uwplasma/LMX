...
from lmx import enable_compilation_cache, write_hartmann_validation_ladder_figure
...
def run_hartmann_validation_ladder(
    *,
        ...
        "hartmann": [
            {
                ...
                "passes_release_target": bool(record["comparison"].l2_error <= L2_TARGET),
            }
    ...
    (out_dir / "hartmann_validation_ladder_summary.json").write_text(json.dumps(summary, indent=2) + "\n")
    return summary
