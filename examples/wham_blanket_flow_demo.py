...
def run_wham_blanket_flow_demo() -> dict[str, object]:
    ...
    print(f"transient_final_pressure_drop = {transient['metrics']['final_pressure_drop_kpa']:.3f} kPa")
    print(f"transient_final_mean_velocity = {transient['metrics']['final_mean_velocity_m_per_s']:.3f} m/s")
