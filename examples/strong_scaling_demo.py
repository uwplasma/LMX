...
def run_strong_scaling_demo(
    *,
    ...
    cpu_problem: tuple[int, int] = (1024, 1024),
    gpu_problem: tuple[int, int] = (2048, 2048),
    iterations: int = 160,
    repeats: int = 3,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--cpu-ny", type=int, default=1024)
    parser.add_argument("--cpu-nz", type=int, default=1024)
    parser.add_argument("--gpu-ny", type=int, default=2048)
    parser.add_argument("--gpu-nz", type=int, default=2048)
