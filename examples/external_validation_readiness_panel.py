...
def run_external_validation_readiness_panel(
    *,
    ...
    plot_paths = write_external_validation_readiness_panel(rows, out_dir, output_stem=OUTPUT_STEM)
    summary = {
    ...
    (out_dir / "external_validation_readiness_summary.json").write_text(json.dumps(summary, indent=2) + "\n")
    return summary
