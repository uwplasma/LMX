...
def run_geometry_panel_demo(*, out_dir: Path) -> dict[str, object]:
    ...
    rect_mesh = generate_rect_duct_mesh(width=1.0, height=1.0, length=2.0, nx=12, ny=24, nz=24)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Write a compact panel with the current LMX geometries.")
