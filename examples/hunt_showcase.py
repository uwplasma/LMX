...
def run_hunt_showcase(
    *,
    ...
    boundary_outputs = write_boundary_layer_figure(solution, out_dir, title="Boundary Layer Development - Hunt")
    volume_outputs = write_velocity_profile_volume_figure(solution, out_dir, title="Liquid Metal Velocity Profile - Hunt", case_kind="hunt")
    ...
    (out_dir / "hunt_showcase_summary.json").write_text(json.dumps(summary, indent=2) + "\n")
    return summary
