...
def run_operator_clustered_verification_demo() -> dict[str, object]:
    ...
    plots = write_operator_verification_plots(records, OUTPUT_DIR, case_title="LMX clustered-mesh operator verification")
    ...
    (OUTPUT_DIR / "operator_clustered_verification_summary.json").write_text(json.dumps(summary, indent=2) + "\n")
    return summary
