...
def test_lmx_lazy_exports_resolve_expected_symbols():
    ...
    assert callable(lmx.research_grade_final_disposition)
    assert callable(lmx.write_research_grade_closure_dashboard)
    ...
    assert callable(lmx.write_research_grade_final_disposition)
