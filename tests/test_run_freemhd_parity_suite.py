...
def test_run_freemhd_parity_suite_uses_available_reference_branches(tmp_path: Path, monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setitem(sys.modules, "examples.freemhd_closed_channel_parity", transient)
    monkeypatch.setitem(sys.modules, "examples.freemhd_closed_channel_observable_parity", observable)
    ...
    assert summary["parity_output"].endswith("freemhd_closed_channel_observable_parity_summary.json")
