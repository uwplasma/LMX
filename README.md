...
The latest complete local gate passes 765 tests with 8 expected external-data
skips and 95.28% branch coverage in 171.1 seconds on six Mac workers. The compact
