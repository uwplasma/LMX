...
The latest complete local gate passes 769 tests with 8 expected external-data
skips and 95.28% branch coverage in 158.0 seconds on six Mac workers. The compact
suite tests physics, numerics, adapters, plotting, and curated workflows directly.
