...
The latest complete local gate passes 768 tests with 8 expected external-data
skips and 95.28% branch coverage in 170.9 seconds on six Mac workers. The compact
