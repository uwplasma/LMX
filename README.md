...
The latest complete local gate passes 796 tests with 8 expected external-data
skips and 95.33% branch coverage in 200.3 seconds on six Mac workers. The compact
