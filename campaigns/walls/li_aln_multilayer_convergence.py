...
def run_li_aln_multilayer_convergence(
    *,
    ...
    print(
        f"pressure convergence pass = {summary['qa']['pressure_last_step_relative_change_pass']}"
    )
    print(
        f"current convergence pass = {summary['qa']['current_last_step_relative_change_pass']}"
    )
    return summary
