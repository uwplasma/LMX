...
from lmx.fringing import magnetic_obstacle_literature_reference_cases
...
def run_magnetic_obstacle_external_reference_template() -> dict[str, object]:
    ...
    summary = {
        ...
        "template_observables": [
            row["observable"] for row in magnetic_obstacle_reference_template_rows()
        ],
    ...
    (
        OUTPUT_DIR / "magnetic_obstacle_external_reference_template_summary.json"
    ).write_text(
