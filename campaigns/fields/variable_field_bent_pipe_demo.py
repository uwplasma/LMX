...
from lmx.plotting import write_bent_pipe_overview_plots
...
def run_variable_field_bent_pipe_demo() -> dict[str, object]:
    ...
    summary = {
        ...
        "bent_validation": validate_bent_pipe_low_de_baseline(
            bent_solution, straight_solution
        ),
        "field_validation": validate_variable_field_pipe_solution(bent_solution),
    }
    (OUTPUT_DIR / "variable_field_bent_pipe_summary.json").write_text(
