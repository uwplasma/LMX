...
Q2D_SIDEWALL_SUMMARY = (
    DOCS_OUTPUT_DIR / "q2d_lmx_q2dmhdfoam_lid_driven_parity_summary.json"
)
MAGNETIC_STRICT_SUMMARY = (
    DOCS_OUTPUT_DIR / "magnetic_obstacle_votyakov_strict_attempt_summary.json"
)
DEAN_STRICT_SUMMARY = (
    DOCS_OUTPUT_DIR / "dean_vortex_bayat_rezai_strict_attempt_summary.json"
)
...
def run_research_grade_closure_dashboard(
    *,
    ...
    print(
        f"strict lanes closed = {summary['closed_lane_count']}/{summary['lane_count']}"
    )
